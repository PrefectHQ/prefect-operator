...
# prefect.io/prefect-operator-bundle:$VERSION and prefect.io/prefect-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= prefect.io/prefect-operator
...
.PHONY: bundle
bundle: manifests tools  ## Generate bundle manifests and metadata, then validate generated files.
...
.PHONY: catalog-build
catalog-build: tools ## Build a catalog image.
